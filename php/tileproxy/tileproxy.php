...
include_once TESTLEAFEXT_PLUGIN_DIR . '/php/tileproxy/restapi.php';
include_once TESTLEAFEXT_PLUGIN_DIR . '/php/tileproxy/admin-ajax.php';
...
function leafext_tileproxy_function( $atts,$content,$shortcode) {
  ...
  if ( $text != "" ) {
    ...
    if (strpos($options['tileurl'],'{s}') !== false ) {
      if ($options['subdomains'] == '') $options['subdomains'] = 'abc';
